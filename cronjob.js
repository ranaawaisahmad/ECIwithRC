...
cron.schedule('24 * * *', () => {
    //code execute when job will run
    ...
    if (req.session.tokens != undefined) {
        ...
        if (req.query.api == "extension") {
            ...
            var params = {
            dateFrom: "2023-10-18T00:00:00.577Z",
            dateTo: "2023-10-20T23:59:59.577Z", // 48 uploaded only and error occure "ContentUri is missing"
            view: "Detailed",
            perPage: 200
            }
    ...
    //Show the message when Cron Job was executed
    logMessage();
});